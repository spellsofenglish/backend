...
import ru.spellsofenglish.authservise.dto.UserDtoForAuth;
import ru.spellsofenglish.authservise.dto.UserDtoForRecoveryPass;
import ru.spellsofenglish.authservise.dto.UserDtoForSave;
import ru.spellsofenglish.authservise.dto.UserDtoForUpdatePass;
...
public class AuthRestController implements GlobalController {
    ...
    public ResponseEntity<?> registration(@Valid @RequestBody UserDtoForSave user) {
